      ...
      return [
        {
          ...
          role: "assistant",
          content:
            "Hello! I can help you manage tasks and answer questions from your saved notes.",
        },
      ];
    });
          ...
          return (
            ...
            >
              <div className="max-w-[90%] sm:max-w-[75%]">
                ...
                >
                  {isFromNotes && (
                    <div className="mb-2 flex w-fit items-center gap-1.5 rounded-full border border-blue-100 bg-blue-50 px-2.5 py-1 text-xs font-medium text-blue-700">
                      <span>
                        📚
                      </span>
      ...
      <footer className="shrink-0 border-t border-gray-200 bg-white px-3 py-3 sm:px-5 sm:py-4">
        <div className="flex items-center gap-1.5 rounded-xl border border-gray-300 bg-gray-50 p-1.5 transition focus-within:border-gray-500 focus-within:bg-white focus-within:ring-2 focus-within:ring-gray-200 sm:gap-2">
          <input
            ...
            disabled={isLoading}
            placeholder="Ask me to manage your tasks or search your notes..."
